...
# Use for debugging this script (check, install, and uninstall package):
# if pip3 show sqlite3 &>/dev/null; then
#     echo "SQLite3 is installed. Uninstalling and reinstalling..."
#     pip3 uninstall sqlite3
